...
const AlertBox = ({ content }: AlertBoxProps) => {
    return (
        <motion.div
            ...
            className={`border border-blue-900/50 bg-blue-800/20 backdrop-blur-md text-neutral-300 p-3 w-[400px] rounded-xl flex items-center gap-x-3 text-[13px] font-mono`}>
